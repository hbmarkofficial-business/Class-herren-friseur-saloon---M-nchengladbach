  ...
  return (
    <>
      <Helmet>
        ...
        <title>Friseursalon Bergisch Gladbach | Class Herrenfriseursalon</title>
        <meta
          name="description"
          content="Besuche unseren Premium Friseursalon Class Herrenfriseursalon in Bergisch Gladbach für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
          content="Barbershop, Herrenfriseur, Haarschnitt, Bartpflege, Rasur, Bergisch Gladbach"
        />
        <link rel="canonical" href="https://gentlemanscut.de" />

        {/* Open Graph */}
        <meta property="og:title" content="Class Herrenfriseursalon | Premium Barbershop Bergisch Gladbach" />
        <meta
        ...
        <meta name="twitter:title" content="Class Herrenfriseursalon | Premium Barbershop Bergisch Gladbach" />
        <meta
